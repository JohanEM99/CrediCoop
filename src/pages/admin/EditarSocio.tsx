...
import { obtenerSocioPorId, actualizarSocio } from '../../services/sociosService';
...
const EditarSocio = () => {
    ...
    const cargarDatosSocio = async () => {
        try {
            ...
            if (!socio) {      // ← VALIDACIÓN OBLIGATORIA
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full pl-10 pr-4 py-3 border rounded-lg ${errors.cedula ? 'border-red-500' : 'border-gray-300'
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full pl-10 pr-4 py-3 border rounded-lg ${errors.fecha_nacimiento ? 'border-red-500' : 'border-gray-300'
                                            } focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                                        disabled={isLoading}
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className={`w-full pl-10 pr-4 py-3 border rounded-lg ${errors.telefono ? 'border-red-500' : 'border-gray-300'
                                            } focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                                        disabled={isLoading}
                                    />
                                </div>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows={3}
                                        className={`w-full pl-10 pr-4 py-3 border rounded-lg ${errors.direccion ? 'border-red-500' : 'border-gray-300'
                                            } focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                                        disabled={isLoading}
                                    />
                                </div>
